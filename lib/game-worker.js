...
export async function getAssassinNamesAndImages(assassinsArr) {
    ...
    return new Promise(async (resolve) => {
        ...
        console.log("assassinsArr passed to getAssassinNamesAndImages")
        console.log(assassinsArr)

        getUsers(assassinIds).then(foundUsers => {

            console.log("foundUsers in getAssassinNamesAndImages")
            ...
            const assassinsWithNames = assassinsArr.map(assassin => {
                ...
                console.log("ASSASSIN return from getAssassinNamesAndImages")
                console.log(assassin)
                return assassin
            })
            console.log("assassinsWithNames being sent back to index")
...
export async function getRequestDisplayNames(requests) {
    ...
    return new Promise(async (resolve) => {
        ...
        getUsers(userIds).then(foundUsers => {
            ...
            console.log("Requests Returned With Names @ game-worker.js")
