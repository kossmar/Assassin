...
export default function AssassinIcon({ name, image = '/images/assassin.png', kills, isWinning, displayKills, isInteractive = false, clickCallback, isSelected = false, id, isProfile }) {
    ...
    return (
        <div>
            ...
            {/* KILL COUNT*/}
                ...
                {/* IMAGE CIRCLE*/}
                <div onClick={(isProfile ? null : handleClick)} className={'rounded-full border-8 ' + (isInteractive && !isProfile ? (isSelected ? 'border-red-600' : 'border-transparent hover:border-red-400') : 'border-transparent')}>
